...
python -m torch.distributed.launch --nproc_per_node $NUM_GPU train.py \
    ...
    --output_dir result/unsup-roberta-base-momentum${lr} \
...
--model_name_or_path result/unsup-roberta-base-momentum${lr} \
--pooler cls_before_pooler \
--task_set sts \
--mode test > log_drop_prob/kmeans_momentum_klr${lr}.log 2>&1
