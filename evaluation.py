...
def main():
    ...
    model = AutoModel.from_pretrained(args.model_name_or_path, cache_dir="model_cache")
    tokenizer = AutoTokenizer.from_pretrained(args.model_name_or_path, cache_dir="model_cache")
